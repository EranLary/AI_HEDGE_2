...
14. When `AI_GATEWAY_API_KEY` is configured, build a date-redacted, Analysis-only
    evidence pack from complete high-signal sections, submit it to Jev, and
    store seven probabilistic direction forecasts.
