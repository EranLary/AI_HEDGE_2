...
const PROMPT_RULES: ClassifyRule[] = [
  ...
  // valuations
  { stages: ["valuation.scenario_dcf"], match: [/.+/], label: "Scenario DCF valuation" },
  { stages: ["valuation.target_scenario"], match: [/.+/], label: "Target scenario valuation" },
  { stages: ["valuation.earnings_scenario"], match: [/.+/], label: "Earnings scenario valuation" },
  { stages: ["valuation.revenue_scenario"], match: [/.+/], label: "Revenue scenario valuation" },
  { stages: ["valuation.composite_scenario"], match: [/.+/], label: "Composite scenario valuation" },
  { stages: ["valuation.sotp_scenario"], match: [/.+/], label: "SOTP scenario valuation" },
  { stages: ["valuation.dream_team"], match: [/.+/], label: "Dream Team valuation" },
...
const STAGE_NAMES: Record<string, string> = {
  ...
  "valuation.scenario_dcf": "Scenario DCF valuation",
  "valuation.target_scenario": "Target scenario valuation",
  "valuation.earnings_scenario": "Earnings scenario valuation",
  "valuation.revenue_scenario": "Revenue scenario valuation",
  "valuation.composite_scenario": "Composite scenario valuation",
  "valuation.sotp_scenario": "SOTP scenario valuation",
  "valuation.dream_team": "Dream Team valuation",
