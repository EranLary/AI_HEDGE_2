...
import { BarChart3, CandlestickChart, Download, FileQuestion, FileText, LineChart, Menu, Scale, Store, Users } from "lucide-react";
...
const SECTIONS: SectionItem[] = [
  ...
  { slug: "wall-st", label: "Wall ST", icon: LineChart },
