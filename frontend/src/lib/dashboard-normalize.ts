...
export function normalizePayload(
  ...
  const merged: DashboardPayload = {
    ...
    web_search: {
      ...(base.web_search || {}),
      ...(payload.web_search || {}),
      queries: Array.isArray(payload.web_search?.queries) ? payload.web_search.queries : base.web_search?.queries || [],
      search_results: Array.isArray(payload.web_search?.search_results) ? payload.web_search.search_results : base.web_search?.search_results || [],
      sources: Array.isArray(payload.web_search?.sources) ? payload.web_search.sources : base.web_search?.sources || [],
      errors: Array.isArray(payload.web_search?.errors) ? payload.web_search.errors : base.web_search?.errors || [],
    },
