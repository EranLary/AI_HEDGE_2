...
def build_prompt(ticker, financial_dict, instruction, text):
  ...
  prompt = f"""
  You are a senior portfolio manager and professional capital allocator (buy-side).
  ...
  Primary objective:
  Internally understand the business, the economics, the risks, and the valuation deeply enough to make a real capital allocation score.
  ...
  I) Score framing and portfolio fit
  ...
  - Arrive at a clear score with conviction level and time horizon.
